...
import com.yj.kedaya.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        // AI 生成
        String result = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, 0.06f);
        // 截取需要的 JSON 信息
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest, HttpServletRequest request) {
        ...
        // AI 生成，SSE 流式返回
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMessage, 0.06f);
